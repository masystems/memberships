...
urlpatterns = [
    ...
    path('organisation_payment_success', views.organisation_payment_success, name='organisation_payment_success'),
    ...
    path('create_card_payment/<int:sub_id>/', views.create_card_payment, name='create_card_payment'),
    path('create_payment_link/<int:sub_id>/', views.create_payment_link, name='create_payment_link'),
